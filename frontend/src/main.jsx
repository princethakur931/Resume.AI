...
import './index.css'
import { getServiceWorkerScriptUrl, initializeNotificationBadging, syncFirebaseConfigToServiceWorker } from './services/notifications'
